...
| [0028](./0028-the-palette-is-ours-and-what-it-guarantees.md)                    | The palette is ours, and what it guarantees                              | The step roles are the promise; the exact values are not, and Radix is gone                  |
| [0029](./0029-the-catalogue-is-opt-in-and-a-scope-carries-the-pair.md)          | The catalogue is opt-in, and a scope carries the pair                    | Twenty-five families as scopes; nine of eighteen accents cannot take white text              |
