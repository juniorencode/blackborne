...
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [running-the-checks.md](./running-the-checks.md) | Every command, what each layer can uniquely answer, how long each takes on which machine, and the five traps that cost an afternoon                                  |
